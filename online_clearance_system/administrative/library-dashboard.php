...
if(isset($_POST["update_status"])){
    ...
    if($conn->query($sql) == TRUE){
        $message = "Library document status updated successfully.";
    }
    else{
...
$sql = "SELECT documents.*, students.name, students.roll, students.department, students.batch
        ...
        WHERE documents.document_name='Library Clearance'
...
if(isset($_POST["update_clearance"])){
    ...
    if($conn->query($update_clearance_sql)){
        $message = "Library clearance request updated successfully.";
    }
    else{
...
$clearance_sql = "SELECT clearance_requests.*, students.name, students.roll, students.department AS student_department
                  ...
                  WHERE clearance_requests.department='Library'
...
<head>
    <meta charset="UTF-8">
    <title>Library Clearance Review</title>
...
<div class="page">
    <div class="left">
        ...
        <div class="nav">
    <a class="nav-item active" href="library-dashboard.php">Library Clearance</a>
</div>
    ...
    <div class="right">
        <div class="top">
            <div class="top-title">Library Clearance</div>
            <div class="top-icons">♧ ✉ ⚙</div>
        </div>

        <div class="content">
            <div class="welcome">Library Clearance Review</div>
            ...
            <div class="frontend-card">
                <div class="section-title">Library Documents</div>
                ...
                <div class="table-box no-shadow">
                    <table>
                        ...
                        if($result->num_rows > 0){
                            ...
                            echo "<tr><td colspan='9'>No library clearance documents found.</td></tr>";
                        }
                        ?>
                    </table>
                </div>
            ...
            <div class="frontend-card">
    <div class="section-title">Library Clearance Applications</div>
                ...
                while($row = $clearance_result->fetch_assoc()){
                    ...
                    echo "<td>
                        <form method='POST' class='table-form'>
                            ...
                            <button type='submit' name='update_clearance' onclick=\"return confirm('Update this Library clearance request?')\">
                                Update
                            </button>
                        </form>
                    </td>";
